...
class SummarizationModel(object):
    ...
    def _add_decoder(self, inputs):
        ...
        outputs, out_state, attn_dists, p_gens, coverage = attention_decoder(inputs, self._dec_in_state, self._enc_states, cell, initial_state_attention=(
    ...
    def _add_seq2seq(self):
                ...
                with tf.variable_scope('loss'):
                    if FLAGS.pointer_gen:  # calculate loss from log_dists
                        ...
                        self._loss = tf.contrib.seq2seq.sequence_loss(tf.stack(
                            vocab_scores, axis=1), self._target_batch, self._padding_mask)  # this applies softmax internally
        ...
        if hps.mode == "decode":
            ...
            self._topk_log_probs, self._topk_ids = tf.nn.top_k(
                log_dists, hps.batch_size * 2)  # note batch_size=beam_size in decode mode
